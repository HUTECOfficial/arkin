...
const BIOMETRIC_CREDENTIALS_KEY = 'arkin-biometric-credentials'
const BIOMETRIC_USER_KEY = 'arkin-biometric-user'
const BIOMETRIC_LOGIN_KEY = 'arkin-biometric-login'
