...
const PASOS_CREDITO = [
  ...
  },
  {
    ...
    bgColor: 'bg-arkin-gold/10',
    borderColor: 'border-arkin-gold/50'
  }
]
...
export default function PanelBrokerPage() {
  ...
  return (
    <div className="min-h-screen bg-arkin-secondary text-arkin-graphite">
      {/* Header */}
      <div className="bg-arkin-secondary/80 backdrop-blur-xl border-b border-white/20 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-arkin-graphite">Panel de Broker</h1>
            ...
            <div className="flex items-center gap-3">
              <Button
                ...
                className={!vistaDetalle ? 'bg-arkin-gold/20 border-arkin-gold text-arkin-gold' : ''}
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <CardContent className="p-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-arkin-graphite">{totalClientes}</p>
                </div>
            ...
            <CardContent className="p-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-arkin-gold">{porFirmar}</p>
                </div>
                <div className="p-3 bg-arkin-gold/10 rounded-xl">
                  <PenTool className="h-7 w-7 text-arkin-gold" />
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        {vistaDetalle && clienteSeleccionado ? (
            ...
            <Card className="bg-arkin-secondary/60 backdrop-blur-xl border-white/40 shadow-lg">
              <CardContent className="p-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <h2 className="text-2xl font-bold text-arkin-graphite">{clienteSeleccionado.clienteNombre}</h2>
            ...
            <Card className="bg-arkin-secondary/60 backdrop-blur-xl border-white/40 shadow-lg">
              <CardHeader>
                <CardTitle className="text-lg font-bold flex items-center gap-2">
                  <Landmark className="h-5 w-5 text-arkin-gold" />
                  Línea de Tiempo · Crédito Hipotecario
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6">
                ...
                <div className="hidden lg:block">
                  ...
                  <div className="relative">
                    ...
                    <div
                      className="absolute top-6 left-0 h-1 bg-arkin-gold rounded-full transition-all duration-500"
                        ...
                        return (
                          <div key={paso.id} className="flex flex-col items-center w-40">
                            <div
                              className={`w-12 h-12 rounded-full flex items-center justify-center z-10 transition-all duration-300 ${
                                estado === 'completado'
                                  ...
                                  : estado === 'actual'
                                  ? 'bg-arkin-gold text-white shadow-lg shadow-arkin-gold/30 ring-4 ring-arkin-gold/20'
                            ...
                            <p className={`text-xs font-semibold mt-3 text-center leading-tight ${
                              estado === 'actual' ? 'text-arkin-gold' : estado === 'completado' ? 'text-green-600' : 'text-gray-400'
                            }`}>
                              {paso.titulo}
                            </p>
                          ...
                          <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center z-10 flex-shrink-0 ${
                              estado === 'completado'
                                ...
                                : estado === 'actual'
                                ? 'bg-arkin-gold text-white ring-4 ring-arkin-gold/20'
                                : 'bg-gray-200 text-gray-400'
                            }`}
                          >
                            {estado === 'completado' ? (
                ...
                <Card className="bg-arkin-secondary/60 backdrop-blur-xl border-white/40 shadow-lg">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="font-bold text-arkin-graphite">Notaría Asignada</h3>
                    </div>
                    <p className="text-sm text-gray-600">{clienteSeleccionado.notaria}</p>
                    {clienteSeleccionado.fechaFirma && (
                      <div className="mt-3 p-3 bg-arkin-gold/10 rounded-xl border border-arkin-gold/30">
                        <p className="text-xs text-arkin-gold font-semibold">Fecha de Firma</p>
                        <p className="text-sm font-bold text-arkin-graphite">
              ...
              <Card className="bg-arkin-secondary/60 backdrop-blur-xl border-white/40 shadow-lg">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-arkin-graphite">Notas</h3>
                  </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold text-arkin-graphite">Mis Clientes en Proceso</h2>
              <Button className="bg-arkin-gold hover:bg-arkin-gold/90 text-white">
            ...
            <div className="space-y-4">
              {clientes.map((cliente) => {
                ...
                return (
                  <Card
                    key={cliente.id}
                    className="bg-arkin-secondary/60 backdrop-blur-xl border-white/40 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group"
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 mb-2">
                            <h3 className="text-lg font-bold text-arkin-graphite truncate">{cliente.clienteNombre}</h3>
                        ...
                        <div className="flex items-center gap-3 lg:min-w-[280px]">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm font-medium text-arkin-graphite truncate">
                        ...
                        {/* Arrow */}
                        <ChevronRight className="h-5 w-5 text-gray-300 group-hover:text-arkin-gold transition-colors hidden lg:block" />
                      </div>
