...
export default function DesarrollosPage() {
  return (
    <div className="min-h-screen bg-arkin-secondary">
          ...
          <div className="max-w-xl">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-12 h-12 bg-arkin-primary rounded-2xl flex items-center justify-center shadow-lg">
                <Building2 className="h-6 w-6 text-arkin-accent" />
              </div>
              <span className="text-arkin-primary text-sm font-semibold uppercase tracking-widest">Nuevos Proyectos</span>
            </div>
            <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-black text-white leading-tight mb-4">
              Desarrollos<br/>
              <span className="text-arkin-primary">Inmobiliarios</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button size="lg" className="bg-arkin-primary hover:bg-arkin-primary/90 text-black font-semibold rounded-xl shadow-lg">
      ...
      {/* Stats */}
      <section className="py-10 bg-arkin-secondary border-b border-arkin-accent/10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-4xl font-bold text-arkin-primary">+3</p>
              <p className="text-arkin-accent/70 text-sm mt-1">Desarrollos Activos</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-arkin-primary">25+</p>
              <p className="text-arkin-accent/70 text-sm mt-1">Unidades Disponibles</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-arkin-primary">3</p>
              <p className="text-arkin-accent/70 text-sm mt-1">Ciudades</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-arkin-primary">25%</p>
              <p className="text-arkin-accent/70 text-sm mt-1">Plusvalía Promedio</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-arkin-secondary/70">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-arkin-graphite mb-4">
