...
import { MapPin, Bed, Bath, Square, Eye, Calendar, Tag } from "lucide-react"
...
export default function VentaPage() {
  ...
  const propiedades = useMemo(() => 
    properties.filter(p => p.categoria === 'venta'), 
    [properties]
  )
        ...
        <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <Badge className="bg-green-500/10 text-green-600">{propiedad.tipo}</Badge>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <Link href={`/propiedades/${propiedad.id}`}>
                      <Button
                        variant="outline"
                        className="border-gray-200 hover:border-green-600 hover:text-green-600 rounded-xl"
                      >
                        Ver Detalles
                      </Button>
                    </Link>
          ...
          {propiedades.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No hay propiedades en venta disponibles</h3>
