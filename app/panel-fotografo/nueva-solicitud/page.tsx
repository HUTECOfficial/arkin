        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card className="border-0 shadow-lg">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Home className="h-5 w-5 text-arkin-primary" />
          ...
          <div className="flex gap-4">
            ...
            <Button
              ...
              className="flex-1 bg-arkin-primary hover:bg-arkin-primary/90 text-arkin-accent"
            >
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center animate-in fade-in zoom-in duration-300">
            <div className="w-20 h-20 bg-arkin-primary rounded-full flex items-center justify-center mx-auto mb-6">
              <CheckCircle className="h-10 w-10 text-arkin-accent" />
            </div>
            ...
            <Button
              onClick={() => router.push('/panel-fotografo')}
              className="w-full bg-arkin-primary hover:bg-arkin-primary/90 text-arkin-accent font-semibold py-3"
            >
              Volver al Panel
            </Button>
          </div>
