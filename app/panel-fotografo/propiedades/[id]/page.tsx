...
export default function SubirImagenesPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-50 flex items-center justify-center">
        <Loader2 className="h-8 w-8 animate-spin text-arkin-gold" />
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-arkin-dark to-gray-900 text-white py-6">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="border-0 shadow-lg mb-8">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Upload className="h-5 w-5 text-arkin-gold" />
              Subir Nuevas Imágenes
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-arkin-gold transition-colors">
                <input
                  type="file"
                  multiple
                  accept="image/*"
              ...
              {selectedFiles.length > 0 && (
                <div>
                  ...
                  {uploading && (
                    <div className="mb-4">
                      <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-arkin-gold rounded-full transition-all duration-300"
                  ...
                  <Button
                    ...
                    disabled={uploading}
                    className="w-full bg-arkin-gold hover:bg-arkin-gold/90 text-black font-semibold py-5"
                  >
                    {uploading ? (
                      <>
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <ImageIcon className="h-5 w-5 text-arkin-gold" />
