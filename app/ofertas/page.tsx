        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 py-16 sm:py-24 flex items-center">
          <div className="max-w-xl">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-red-400 text-sm font-semibold uppercase tracking-widest">Arkin Select</span>
            </div>
            <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-black text-white leading-tight mb-4">
              Propiedades<br/>
              <span className="text-red-400">en Oferta</span>
            </h1>
            ...
            <Badge className="bg-red-500 text-white border-0 px-4 py-2 text-sm font-semibold shadow-lg">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {propiedades.map((propiedad) => (
              <div
                key={propiedad.id}
                className="group bg-arkin-secondary/50 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-red-500/30"
              >
                {/* Image */}
