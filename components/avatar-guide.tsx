...
const GUIDE_SPEECHES: GuideSpeech[] = [
  {
    ...
    title: "¡Bienvenido!",
    icon: Sparkles,
    speech: "¡Hola! Soy tu guía virtual de ARKIN SELECT. Te voy a mostrar cómo navegar por nuestra plataforma inmobiliaria de manera rápida y sencilla. Somos tu inmobiliaria de confianza en León, Guanajuato. ¡Empecemos!",
    shortSpeech: "Bienvenido a ARKIN SELECT, tu inmobiliaria de confianza.",
    route: "/",
    scrollToTop: true,
  },
  {
  ...
  },
  {
    ...
    title: "¡Listo!",
    icon: Sparkles,
    speech: "¡Eso es todo! Ya conoces lo básico de ARKIN SELECT. Recuerda: proceso transparente, sin complicaciones y conexión directa entre compradores y vendedores. ¡Explora y encuentra tu próximo hogar!",
...
export function AvatarGuide() {
  ...
  useEffect(() => {
    ...
    const seen = localStorage.getItem("arkin-guide-seen")
    if (!seen) {
  ...
  const handleDismissPrompt = () => {
    setShowPrompt(false)
    localStorage.setItem("arkin-guide-seen", "true")
    setHasSeenGuide(true)
  }
    ...
    <>
      ...
      {showPrompt && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
          <Card className="max-w-md w-full p-6 bg-arkin-secondary border-arkin-accent/20 rounded-3xl shadow-2xl animate-in zoom-in-95 duration-300">
            <div className="text-center space-y-4">
              {/* Avatar */}
              <div className="relative w-24 h-24 mx-auto">
                <div className="absolute inset-0 bg-gradient-to-br from-arkin-primary to-arkin-gold rounded-full animate-pulse"></div>
                <div className="absolute inset-1 bg-arkin-secondary rounded-full flex items-center justify-center">
                  <Image
                    src="/arkinlogo.jpg"
                    alt="ARKIN Guide"
                    width={80}
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-arkin-accent mb-2">
                  ¡Hola! ¿Primera vez aquí?
                </h3>
                <p className="text-arkin-accent/70 text-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <Button
                  ...
                  className="flex-1 bg-arkin-primary hover:bg-arkin-primary/90 text-arkin-accent font-semibold rounded-xl py-3"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex-1 border-arkin-accent/20 text-arkin-accent hover:bg-arkin-accent/5 rounded-xl py-3"
                >
                  Ya conozco, gracias
                </Button>
              </div>
      ...
      {hasSeenGuide && !isOpen && (
        <Button
          ...
          className="fixed bottom-24 right-4 sm:bottom-28 sm:right-8 w-12 h-12 rounded-full bg-gradient-to-r from-arkin-primary to-arkin-gold hover:from-arkin-gold hover:to-arkin-primary text-arkin-accent shadow-xl hover:shadow-arkin-primary/30 transition-all duration-300 z-40 hover:scale-110 group"
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[10001] flex items-end sm:items-center justify-center p-0 sm:p-4 pointer-events-none">
          ...
          <Card className="w-full sm:max-w-lg sm:rounded-3xl rounded-t-3xl rounded-b-none bg-arkin-secondary border-arkin-accent/20 shadow-2xl overflow-hidden animate-in slide-in-from-bottom duration-300">
            {/* Header */}
            <div className="bg-gradient-to-r from-arkin-graphite to-gray-900 p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gradient-to-br from-arkin-primary to-arkin-gold rounded-full flex items-center justify-center">
            ...
            {/* Progress Bar */}
            <div className="h-1 bg-arkin-accent/10">
              <div 
                className="h-full bg-gradient-to-r from-arkin-primary to-arkin-gold transition-all duration-300"
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-center">
                <div className={`relative w-20 h-20 ${isPlaying ? 'animate-pulse' : ''}`}>
                  <div className="absolute inset-0 bg-gradient-to-br from-arkin-primary to-arkin-gold rounded-full"></div>
                  <div className="absolute inset-1 bg-arkin-secondary rounded-full flex items-center justify-center overflow-hidden">
                    <Image
                      src="/arkinlogo.jpg"
                      alt="ARKIN Guide"
                      width={72}
                  ...
                  {isPlaying && (
                    <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 flex gap-0.5">
                      <div className="w-1 h-3 bg-arkin-primary rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></div>
                      <div className="w-1 h-4 bg-arkin-gold rounded-full animate-bounce" style={{ animationDelay: '150ms' }}></div>
                      <div className="w-1 h-3 bg-arkin-primary rounded-full animate-bounce" style={{ animationDelay: '300ms' }}></div>
                    </div>
                  )}
                </div>
              </div>
              ...
              {/* Speech Text */}
              <div className="bg-arkin-accent/5 rounded-2xl p-4 min-h-[100px]">
                <p className="text-arkin-accent text-sm leading-relaxed">
            ...
            {/* Controls */}
            <div className="p-4 bg-arkin-accent/5 border-t border-arkin-accent/10 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={toggleMute}
                  className="rounded-full w-10 h-10 text-arkin-accent hover:bg-arkin-accent/10"
                >
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className="rounded-xl border-arkin-accent/20 text-arkin-accent hover:bg-arkin-accent/5 disabled:opacity-30"
                >
                ...
                <Button
                  size="sm"
                  onClick={handleNext}
                  className="rounded-xl bg-arkin-primary hover:bg-arkin-primary/90 text-arkin-accent font-semibold"
                >
