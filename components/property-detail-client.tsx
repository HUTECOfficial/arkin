        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="relative rounded-2xl overflow-hidden bg-gray-900 aspect-video group">
              ...
              {propertyData.tourVirtual && (
                <button
                  ...
                  className="absolute top-4 left-4 px-4 py-2 bg-arkin-gold hover:bg-arkin-gold/90 text-black rounded-full font-medium flex items-center gap-2"
                >
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-4xl font-bold text-arkin-gold mb-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium">Asesor ARKIN</p>
