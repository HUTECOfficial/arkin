    ...
    const individualPlans = [
        {
            ...
            highlight: false,
            badge: "Básico",
            cardClass: "border-arkin-accent/10 bg-arkin-secondary/60 backdrop-blur-lg hover:-translate-y-1",
            iconBg: "bg-arkin-accent/5",
            iconColor: "text-arkin-accent/70",
            badgeClass: "bg-arkin-accent/5 text-arkin-accent",
            titleColor: "text-arkin-accent",
            descColor: "text-arkin-accent/60",
            priceColor: "text-arkin-accent",
            periodColor: "text-arkin-accent/50",
            propColor: "font-semibold text-arkin-accent/80",
            checkColor: "text-arkin-accent/40",
            featureColor: "text-arkin-accent/70",
            btnClass: "bg-arkin-accent/5 hover:bg-arkin-accent/10 text-arkin-accent",
        },
        {
            id: "elite",
            name: "Plan Elite",
            ...
            highlight: true,
            badge: "Más Popular",
            // Fondo oscuro (arkin-accent = grafito), texto amarillo (arkin-primary)
            cardClass: "border-arkin-primary shadow-xl scale-105 z-10 bg-arkin-accent backdrop-blur-xl",
            iconBg: "bg-arkin-primary/20",
            iconColor: "text-arkin-primary",
            badgeClass: "bg-arkin-primary/20 text-arkin-primary",
            titleColor: "text-white",
            descColor: "text-white/60",
            priceColor: "text-arkin-primary",
            periodColor: "text-white/50",
            propColor: "font-semibold text-white/80",
            checkColor: "text-arkin-primary",
            featureColor: "text-white/70",
            btnClass: "bg-arkin-primary hover:bg-arkin-primary/90 text-arkin-accent shadow-lg hover:shadow-xl",
        }
    ]
    ...
    const teamPlans = [
        {
            ...
            highlight: false,
            badge: "Equipo",
            // Negativo del Core: fondo oscuro (arkin-accent), texto claro
            cardClass: "border-white/10 bg-arkin-accent backdrop-blur-lg hover:-translate-y-1",
            iconBg: "bg-white/5",
        ...
        },
        {
            ...
            highlight: true,
            badge: "Más Popular",
            // Negativo del Elite: fondo amarillo (arkin-primary), texto oscuro (arkin-accent)
            cardClass: "border-arkin-accent/30 shadow-xl scale-105 z-10 bg-arkin-primary backdrop-blur-xl",
            iconBg: "bg-arkin-accent/10",
            iconColor: "text-arkin-accent",
            badgeClass: "bg-arkin-accent/10 text-arkin-accent",
            titleColor: "text-arkin-accent",
            descColor: "text-arkin-accent/60",
            priceColor: "text-arkin-accent",
            periodColor: "text-arkin-accent/50",
            propColor: "font-semibold text-arkin-accent/80",
            checkColor: "text-arkin-accent",
            featureColor: "text-arkin-accent/70",
            btnClass: "bg-arkin-accent hover:bg-arkin-accent/90 text-arkin-primary shadow-lg hover:shadow-xl",
        }
    ]
    ...
    return (
        <div className="min-h-screen bg-arkin-secondary relative overflow-hidden transition-all duration-500">
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-arkin-primary/10 rounded-full blur-3xl animate-pulse-slow" />
                <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-arkin-primary/5 rounded-full blur-3xl animate-float" />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-arkin-primary/5 rotate-45 blur-2xl" />
            </div>
            ...
            <div className="relative z-10 pt-24 pb-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex justify-center mb-12">
                        <div className="relative flex items-center bg-arkin-accent/8 border border-arkin-accent/15 rounded-2xl p-1.5 gap-1 shadow-inner">
                            {/* Sliding pill */}
                            <div
                                className="absolute top-1.5 bottom-1.5 rounded-xl bg-arkin-accent transition-all duration-300 ease-in-out shadow-md"
                                style={{
                            ...
                            <button
                                ...
                                className={`relative z-10 flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold transition-colors duration-300 ${
                                    !isTeam ? 'text-arkin-primary' : 'text-arkin-accent/60 hover:text-arkin-accent'
                                }`}
                            >
                            ...
                            >
                                ...
                                Equipo
                                <span className="ml-1 text-xs bg-arkin-primary/20 text-arkin-primary px-1.5 py-0.5 rounded-full font-bold">
                                    -40%
                                </span>
                            </button>
                        </div>
                    ...
                    {/* Subtitle for team */}
                    {isTeam && (
                        <p className="text-center text-arkin-accent/60 text-sm mb-8 -mt-6">
                                ...
                                >
                                    {plan.highlight && (
                                        <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                                            <Badge className="bg-arkin-primary text-arkin-accent px-4 py-1 font-bold shadow-lg">
                                                {plan.badge}
                                            </Badge>
                                        </div>
                                    )}
