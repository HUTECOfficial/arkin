...
export function ShepherdTour() {
  ...
  const startTour = useCallback(async () => {
    ...
    tour.addStep({
      ...
      text: `
        <div style="text-align:center; margin-bottom: 12px;">
          <img src="/arkinlogo.jpg" alt="ARKIN" style="height:48px; margin:0 auto; border-radius:12px;" />
        </div>
    ...
    tour.addStep({
      ...
      text: "Aquí encontrarás nuestro <strong>video de presentación</strong> y los accesos rápidos para <strong>explorar propiedades</strong> o <strong>vender tu propiedad</strong>. Es la primera impresión de ARKIN SELECT.",
    ...
    tour.addStep({
      ...
      text: "Ahora te muestro la sección de <strong>Propietarios</strong>, donde puedes registrar tu propiedad para que ARKIN SELECT la promueva con la mejor estrategia de mercado.",
      buttons: [
        { text: "Anterior", classes: "shepherd-button-secondary", action: () => tour.back() },
        {
    ...
    tour.addStep({
      ...
      text: "Veamos la sección de <strong>Contacto</strong> donde puedes comunicarte directamente con el equipo ARKIN.",
      buttons: [
        { text: "Anterior", classes: "shepherd-button-secondary", action: () => tour.back() },
        {
          text: "Ir a Contacto →",
    ...
    tour.addStep({
      ...
      text: `
        ...
        <ul style="margin:8px 0;padding-left:16px;">
          ...
          <li><strong>Email:</strong> arkinselect@gmail.com</li>
    ...
    tour.addStep({
      ...
      text: `
        <p>Si eres <strong>asesor, broker o fotógrafo</strong>, ARKIN SELECT tiene un panel exclusivo para ti:</p>
        <ul style="margin:8px 0;padding-left:16px;">
    ...
    tour.addStep({
      ...
      text: `
        <div style="text-align:center;">
          ...
          <p style="font-size:16px;font-weight:600;margin-bottom:12px;">Ya conoces toda la plataforma ARKIN SELECT</p>
  ...
  useEffect(() => {
    ...
    window.addEventListener("arkin-start-tour", handler)
    return () => window.removeEventListener("arkin-start-tour", handler)
  }, [startTour])
